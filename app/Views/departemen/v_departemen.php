  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Departemen</h6>
      </nav>
      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex justify-content mb-3">
            <a href="<?= base_url()?>/dept/input" class="btn btn-primary">
              <i class="fa fa-plus me-1"></i> Tambah Departemen
            </a>
          </div>
                ...
                <table class="table table-dark table-hover custom-row-border mb-0">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?= $no++; ?></td>
                        <td><?= $dpt['nm_departemen']?></td>
                        <td><?= $dpt['nm_perusahaan']?></td>
                        <td>
                          <a href="<?= base_url().'dept/edit/'.$dpt['id_departemen']?>">
                            <button class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></button>
                          </a>
                          <a href="<?= base_url().'dept/hapus/'.$dpt['id_departemen']?>">
