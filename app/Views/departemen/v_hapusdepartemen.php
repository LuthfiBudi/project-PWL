    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-white active" aria-current="page">Hapus Departemen</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Hapus Departemen</h6>
      </nav>
      ...
      <div class="col-lg-6">
        <div class="card bg-dark text-white border-radius-lg shadow">
          <div class="card-header pb-0">
            <h4 class="text-white">Hapus Departemen?</h4>
          </div>
          <div class="card-body">
            <form action="<?= base_url()?>dept/delete" method="post">
              <?php
              ...
              <div class="mb-3">
                ...
                <input readonly type="text" value="<?= $dpt['nm_departemen']?>" class="form-control bg-transparent text-muted border border-white" id="nm_departemen" name="nm_departemen" placeholder="Masukkan nama perusahaan" required>
              </div>
              <div class="mb-3">
                <label for="nama_departemen" class="form-label text-white">Nama Perusahaan</label>
                <select disabled name="id_perusahaan" id="id_perusahaan" class="form-control bg-transparent text-muted border border-white" required>
