    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-white active" aria-current="page">Input Karyawan</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Input Karyawan</h6>
      </nav>
          ...
          <div class="card-body">
            <form action="<?= base_url()?>employee/save" method="post">
              <div class="mb-3">
                ...
                <input type="text" class="form-control bg-transparent text-white border border-white" id="nm_karyawan" name="nm_karyawan" placeholder="Masukkan nama karyawan" required>
              </div>
              <div class="mb-3">
                ...
                <select name="id_departemen" id="" class="form-control bg-light border border-white" required>
                  ...
                  <?php 
                    foreach ($departemen as $dpt) {
                      # code...
                  ?>
                    <option value="<?= $dpt['id_departemen']?>">
                      <?= $dpt['nm_departemen']?>
                    </option>
                    <?php
                    }
