  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Karyawan</h6>
      </nav>
      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex justify-content mb-3">
            <a href="<?= base_url()?>employee/input" class="btn btn-primary">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?= $emp['nm_karyawan']?></td>
                        <td><?= $emp['nm_perusahaan']?></td>
                        <td><?= $emp['nm_departemen']?></td>
                        <td>
                          <a href="<?= base_url().'employee/edit/'.$emp['id_karyawan']?>">
                            <button class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></button>
                          </a>
                          <a href="<?= base_url().'employee/hapus/'.$emp['id_karyawan']?>">
